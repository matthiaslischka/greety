...
namespace Greety.Tests.StaticCodeAnalysis
{
    public class DependencyChecks
    {
        ...
        {
            var dependencyChecker = DependencyChecker.Create(HappyZoneTypesProvider.HappyZoneNamespace);
        ...
        private void Dump(IEnumerable<IDependencyError> errors)
        {
            ...
            {
                _testOutput.WriteLine($"{error.HappyZoneTypeName} references {error.NonHappyZoneTypeName} in {error.DependencyType} {error.ElementName}.");
            }
        }
    }
}
